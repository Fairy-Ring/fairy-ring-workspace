...
1. **Do not invent** (a dest/stat/line/% with **no RuneScape cite**). Last-resort 2007-base **is** a cite. A labeled **CANDIDATE** from leftover / pack / period / 2007-base is a **best guess**, not invent. Ship it; update when a better source appears.  
   The bar is **Lost City’s**: when period is silent, map OSRS / 2007-base and walk **backward** (minus Changes). [oldschool.runescape.wiki](https://oldschool.runescape.wiki) is trusted **to OSRS**; its Changes / Update history are the dated line. Later OSRS “socially acceptable” dialogue rewrites are **SUBTRACT** — not a 2006→2007 change; we keep period voice. Do not dest onto an L1 plank or into a room our 377 maps do not have.  
