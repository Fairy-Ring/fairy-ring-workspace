...
def main() -> None:
    ...
    parser.add_argument("--data-dir", type=Path, default=None,
                        help="nav data dir. Default: ../data next to this script.")
    parser.add_argument("--rs2b0t", type=Path, default=None,
                        help="legacy: rs2b0t root (ignored if --data-dir set)")
    parser.add_argument("--transports-output", type=Path, default=None)
    parser.add_argument("--stairs-output", type=Path, default=None)
    ...
    if args.transports_output is None:
        args.transports_output = data_dir / "transports.json"
    if args.stairs_output is None:
        args.stairs_output = data_dir / "stairEdges.json"
